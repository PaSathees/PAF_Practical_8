...
var status = validateItemForm();
	...
	var student = getStudentCard($("#txtName").val().trim(), 
								...
								$("#alertSuccess").show(); $("#formStudent")[0].reset();
});
...
function getStudentCard(name, gender, year) {
	...
	student += "<div class=\"student card bg-light m-2\" style=\"max-width: 10rem; float: left;\">"; student += "<div class=\"card-body\">";
	student += title + " " + name + ","; student += "<br>";
	student += yearNumber + " year"; student += "</div>";
	student += "<input type=\"button\" value=\"Remove\" class=\"btn btn-danger remove\">";
	student += "</div>"; return student;
